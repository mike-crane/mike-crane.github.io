!(function(e, t) {
  ...
  function s(e) {
    var t = {};
    return (
      he.each(e.match(Ae) || [], function(e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function b(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && he.inArray(o, r) > -1) i && i.push(o);
        ...
        ((c = he.contains(o.ownerDocument, o)),
  ...
  function j(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        He.hasData(e) &&
        ((o = He.access(e)), (a = He.set(t, o)), (c = o.events))
      ) {
  ...
  function D(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      m = he.isFunction(h);
    if (m || (p > 1 && "string" == typeof h && !de.checkClone && tt.test(h)))
    ...
    if (
      ...
      for (s = he.map(y(o, "script"), S), u = s.length; f < p; f++)
        (c = o),
          f !== d &&
            ((c = he.clone(c, !0, !0)), u && he.merge(s, y(c, "script"))),
          r.call(e[f], c, f);
      if (u)
        for (l = s[s.length - 1].ownerDocument, he.map(s, N), f = 0; f < u; f++)
          (c = s[f]),
            Xe.test(c.type || "") &&
  ...
  function $(e, t, n, r, i) {
    ...
    for (
      ...
      "margin" === n && (a += he.css(e, n + Ie[o], !0, i)),
        r
          ? ("content" === n && (a -= he.css(e, "padding" + Ie[o], !0, i)),
            "margin" !== n &&
              (a -= he.css(e, "border" + Ie[o] + "Width", !0, i)))
          : ((a += he.css(e, "padding" + Ie[o], !0, i)),
            "padding" !== n &&
              (a += he.css(e, "border" + Ie[o] + "Width", !0, i)));
    return a;
  }
  function M(e, t, n) {
    ...
    return ot.test(o)
      ? o
      : ((r = a && (de.boxSizingReliable() || o === e.style[t])),
        "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (o = parseFloat(o) || 0) +
          $(e, t, n || (a ? "border" : "content"), r, i) +
          "px");
  }
      ...
      for (r in d)
        u ||
          (g
            ...
            : (g = He.access(e, "fxshow", { display: c })),
          o && (g.hidden = !m),
          m && v([e], !0),
          p.done(function() {
  ...
  function X(e, t, n) {
    ...
    for (U(l, c.opts.specialEasing); o < a; o++)
      if ((r = X.prefilters[o].call(c, e, l, c.opts)))
        return (
          he.isFunction(r.stop) &&
            (he._queueHooks(c.elem, c.opts.queue).stop = he.proxy(r.stop, r)),
          r
        );
    return (
      he.map(l, z, c),
      ...
      he.fx.timer(he.extend(u, { elem: e, anim: c, queue: c.opts.queue })),
      c
    );
  }
  function V(e) {
  ...
  (he.fn = he.prototype = {
        ...
        if (null != (e = arguments[s]))
          for (t in e)
            (n = a[t]),
              (r = e[t]),
              a !== r &&
                (c && r && (he.isPlainObject(r) || (i = Array.isArray(r)))
                  ? (i
    ...
    "function" == typeof Symbol &&
      (he.fn[Symbol.iterator] = te[Symbol.iterator]),
    he.each(
  ...
  var xe = (function(e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : R) !== L && D(t), (t = t || L), F)
      ) {
        if (11 !== h && (u = me.exec(e)))
          if ((i = u[1])) {
            if (9 === h) {
            ...
            } else if (d && (a = d.getElementById(i)) && $(t, a) && a.id === i)
              return n.push(a), n;
          } else {
      ...
      return (
        ...
        r(function(r, a, s, u) {
          var c,
            ...
            x = n ? (o || (r ? e : g || i) ? [] : a) : y;
          if ((n && n(y, x, s, u), i))
            for (c = m(x, d), i(c, [], s, u), l = c.length; l--; )
              (f = c[l]) && (x[d[l]] = !(y[d[l]] = f));
          if (r) {
            if (o || e) {
              if (o) {
          ...
          } else (x = m(x === a ? x.splice(g, x.length) : x)), o ? o(null, a, x, u) : Q.apply(a, x);
        })
      );
    }
    function v(e) {
      ...
      var i = n.length > 0,
        ...
        a = function(r, a, s, u, c) {
          ...
          for (
            ...
            if (o && l) {
              for (
                f = 0, a || l.ownerDocument === L || (D(l), (s = !F));
                (p = e[f++]);
    ...
    try {
      Q.apply((V = J.call(R.childNodes)), R.childNodes),
    ...
    (b = t.support = {}),
          ...
          ? ((L = r),
            ...
            (b.getById = i(function(e) {
              return (
                ...
                !L.getElementsByName || !L.getElementsByName(M).length
              );
            })),
            b.getById
              ...
              ? function(e, t) {
                  ...
                  return (
                    ...
                    (!b.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === L || (e.ownerDocument === R && $(R, e))
                        ? -1
                        : t === L || (t.ownerDocument === R && $(R, t))
                          ? 1
                          : j
                            ? K(j, e) - K(j, t)
                            : 0
      ...
      (t.contains = function(e, t) {
        return (e.ownerDocument || e) !== L && D(e), $(e, t);
      }),
      (t.attr = function(e, t) {
        (e.ownerDocument || e) !== L && D(e);
    ...
    if (((n = n || ke), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          he.merge(
            this,
            he.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)
          ),
      ...
      function(e, t) {
        he.fn[e] = function(n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (je[e] || he.uniqueSort(i), Ne.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
              ...
              return he
                .Deferred(function(e) {
                  n[0][3].add(o(0, e, he.isFunction(i) ? i : u, e.notifyWith)),
                    ...
                    n[2][3].add(o(0, e, he.isFunction(r) ? r : c));
                })
                .promise();
            },
            promise: function(e) {
    ...
    he.extend({
      ...
      ready: function(e) {
        (!0 === e ? --he.readyWait : he.isReady) ||
          ((he.isReady = !0),
          (!0 !== e && --he.readyWait > 0) || Le.resolveWith(ne, [he]));
      }
    }),
    (he.ready.then = Le.then),
        ...
        if (void 0 !== r) {
          if (void 0 !== t) {
            Array.isArray(t)
              ...
              : ((t = he.camelCase(t)), (t = t in r ? [t] : t.match(Ae) || [])),
              (n = t.length);
            for (; n--; ) delete r[t[n]];
          }
    ...
    he.fn.extend({
      data: function(e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = Oe.get(o)), 1 === o.nodeType && !He.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
      ...
      queue: function(e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = He.access(e, t, he.makeArray(n)))
                : r.push(n)),
            r || []
          );
      },
  ...
  he.extend({
    ...
    clone: function(e, t, n) {
      ...
      return (
        (a = y(s, "script")), a.length > 0 && x(a, !u && y(e, "script")), s
      );
    },
  ...
  he.extend({
      ...
      he.cssHooks[t] = {
        ...
        set: function(e, n, r) {
          var i,
            ...
            a =
              r &&
              $(e, t, r, "border-box" === he.css(e, "boxSizing", !1, o), o);
          return (
            a &&
              (i = Re.exec(n)) &&
              "px" !== (i[3] || "px") &&
    ...
    (he.cssHooks.marginLeft = F(de.reliableMarginLeft, function(e, t) {
      if (t)
        return (
  ...
  he.fn.extend({
    attr: function(e, t) {
      return qe(this, he.attr, e, t, arguments.length > 1);
    },
  ...
  he.fn.extend({
    prop: function(e, t) {
      return qe(this, he.prop, e, t, arguments.length > 1);
    },
  ...
  he.fn.extend({
    val: function(e) {
        ...
        i = this[0];
      {
        ...
        if (i)
          return (t =
            he.valHooks[i.type] || he.valHooks[i.nodeName.toLowerCase()]) &&
            "get" in t &&
            ...
            c
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                    ? (T = "notmodified")
                    : ((T = b.state), (p = b.data), (d = b.error), (c = !d)))
  ...
  (de.cors = !!Bt && "withCredentials" in Bt),
    (de.ajax = Bt = !!Bt),
    he.ajaxTransport(function(t) {
      var n, r;
      if (de.cors || (Bt && !t.crossDomain))
        return {
          send: function(i, o) {
            var a,
              s = t.xhr();
  ...
  he.ajaxSetup({
    ...
    he.ajaxPrefilter("json jsonp", function(t, n, r) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          (i = t.jsonpCallback = he.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
    ...
    (he.fn.load = function(e, t, n) {
      var r,
        ...
        s = e.indexOf(" ");
      return (
        s > -1 && ((r = V(e.slice(s))), (e = e.slice(0, s))),
        he.isFunction(t)
          ? ((n = t), (t = void 0))
    ...
    he.each(["top", "left"], function(e, t) {
      he.cssHooks[t] = F(de.pixelPosition, function(e, n) {
        if (n)
          return (n = q(e, t)), ot.test(n) ? he(e).position()[t] + "px" : n;
      });
    }),
    he.each({ Height: "height", Width: "width" }, function(e, t) {
      he.each({ padding: "inner" + e, content: t, "": "outer" + e }, function(
        n,
        r
      ) {
  ...
  return (
    (he.noConflict = function(t) {
      return (
        e.$ === he && (e.$ = Xt), t && e.jQuery === he && (e.jQuery = Ut), he
      );
    }),
    t || (e.jQuery = e.$ = he),
    he
  ...
  (window.Modernizr = (function(e, t, n) {
    ...
    function c(e, t, n) {
      var r = e.charAt(0).toUpperCase() + e.slice(1),
        i = (e + " " + T.join(r + " ") + r).split(" ");
      return o(t, "string") || o(t, "undefined")
        ? s(i, t)
        : ((i = (e + " " + C.join(r + " ") + r).split(" ")), u(i, t, n));
    }
    var l,
      f,
      p = {},
      ...
      L = function(t) {
        ...
        var r;
        return (
          D("@media " + t + " { #" + h + " { position: absolute; } }", function(
            t
          ) {
            r =
              "absolute" ==
    ...
    (f =
          ...
          var n = A.call(arguments, 1),
            r = function() {
              if (this instanceof r) {
                ...
                var o = new i(),
                  a = t.apply(o, n.concat(A.call(arguments)));
      ...
      (k.hashchange = function() {
        return (
          q("hashchange", e) && (t.documentMode === n || t.documentMode > 7)
        );
      }),
      (k.history = function() {
      ...
      (k.fontface = function() {
        var e;
        return (
          D('@font-face {font-family:"font";src:url("https://")}', function(
            n,
            r
          ) {
    ...
    return (
      p.input ||
        (function() {
          (p.input = (function(n) {
            for (var r = 0, i = n.length; r < i; r++) N[n[r]] = n[r] in v;
            return (
              N.list &&
                (N.list =
            ...
            (p.inputtypes = (function(e) {
              for (var r, i, o, a = 0, s = e.length; a < s; a++)
                v.setAttribute("type", (i = e[a])),
                  (r = "text" !== v.type),
                  r &&
                    ((v.value = y),
                    (v.style.cssText = "position:absolute;visibility:hidden;"),
                    /^range$/.test(i) && v.style.WebkitAppearance !== n
                      ? (d.appendChild(v),
                        (o = t.defaultView),
                        (r =
                          o.getComputedStyle &&
                          "textfield" !==
                            o.getComputedStyle(v, null).WebkitAppearance &&
                          0 !== v.offsetHeight),
                        d.removeChild(v))
                      : /^(search|tel)$/.test(i) ||
                        (r = /^(url|email)$/.test(i)
  ...
  (function(e, t, n) {
    ...
    function u(e, n, r, i, o, u, c) {
      ...
      1 === S[n] && ((g = 1), (S[n] = [])),
        ...
        "img" != e &&
          (g || 2 === S[n]
            ? (w.insertBefore(f, b ? null : m), h(l, c))
            : S[n].push(f));
    }
    ...
    (p = function(e) {
      function t(e) {
        ...
        for (n = 0; n < a; n++)
          (r = e[n].split("=")), (t = N[r.shift()]) && (o = t(o, r));
        for (n = 0; n < i; n++) o = k[n](o);
        return o;
      }
      ...
      if (i(e)) a(e, 0, f, 0);
        ...
        for (u = 0; u < e.length; u++)
          (c = e[u]),
            i(c) ? a(c, 0, f, 0) : E(c) ? p(c) : Object(c) === c && s(c, f);
      ...
      (e.yepnope.injectJs = function(e, n, r, i, u, c) {
        var l,
          f,
        ...
        (n = c ? s : n || o),
          (d.onreadystatechange = d.onload = function() {
            !l &&
              a(d.readyState) &&
              ((l = 1), n(), (d.onload = d.onreadystatechange = null));
          }),
          h(function() {
            l || ((l = 1), n(1));
          }, i),
          u ? d.onload() : m.parentNode.insertBefore(d, m);
      }),
  ...
  (function(e) {
    ...
    if (
      ...
      var s,
        ...
        h = [],
        m = {},
        g = l.getElementsByTagName("head")[0] || f,
        v = l.getElementsByTagName("base")[0],
        ...
        x = function() {
          ...
          return (
            ...
            n ||
              ((n = o = l.createElement("body")),
              (n.style.background = "none")),
            (f.style.fontSize = "100%"),
            (n.style.fontSize = "100%"),
            n.appendChild(t),
            o && f.insertBefore(n, f.firstChild),
            (e = t.offsetWidth),
            o ? f.removeChild(n) : n.removeChild(t),
            (f.style.fontSize = r),
        ...
        b = function(t) {
          var n = f.clientWidth,
            r = ("CSS1Compat" === l.compatMode && n) || l.body.clientWidth || n,
            i = {},
            o = y[y.length - 1],
            a = new Date().getTime();
          if (t && s && a - s < 30)
            return e.clearTimeout(u), void (u = e.setTimeout(b, 30));
          s = a;
          for (var m in p)
            if (p.hasOwnProperty(m)) {
              var v = p[m],
                ...
                C = null === w,
                E = null === T;
              w && (w = parseFloat(w) * (w.indexOf("em") > -1 ? c || x() : 1)),
                T &&
                  (T = parseFloat(T) * (T.indexOf("em") > -1 ? c || x() : 1)),
                (v.hasquery &&
                  ((C && E) || !(C || r >= w) || !(E || r <= T))) ||
                  (i[v.media] || (i[v.media] = []),
                  i[v.media].push(d[v.rules]));
            }
          for (var k in h)
            h.hasOwnProperty(k) &&
              h[k] &&
          ...
          for (var S in i)
            if (i.hasOwnProperty(S)) {
              ...
              (N.type = "text/css"),
                (N.media = S),
                g.insertBefore(N, o.nextSibling),
                N.styleSheet
                  ? (N.styleSheet.cssText = j)
                  : N.appendChild(l.createTextNode(j)),
                h.push(N);
            }
        },
        w = function(e, t, r) {
          var i = e
              .replace(n.regex.comments, "")
              .replace(n.regex.keyframes, "")
              .match(n.regex.media),
            o = (i && i.length) || 0;
          ...
          for (var c = 0; c < o; c++) {
            ...
            u
              ? ((l = r), d.push(s(e)))
              : ((l = i[c].match(n.regex.findStyles) && RegExp.$1),
                d.push(RegExp.$2 && s(RegExp.$2))),
              (h = l.split(",")),
              (m = h.length);
            for (var g = 0; g < m; g++)
              (f = h[g]),
                a(f) ||
                  p.push({
                    media:
                      (f.split("(")[0].match(n.regex.only) && RegExp.$2) ||
                      "all",
                    rules: d.length - 1,
                    hasquery: f.indexOf("(") > -1,
                    minw:
                      f.match(n.regex.minw) &&
                      parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                    maxw:
                      f.match(n.regex.maxw) &&
                      parseFloat(RegExp.$1) + (RegExp.$2 || "")
                  });
          }
          b();
  ...
  $(document).ready(function() {
    ...
    $("#contact").click(function () {
      ...
      $('.top-left-box').on('click', function () {
        $('#overlay').show('slow');
        $('.top-left-box-big').show('slow');
        $('body').css("overflow", "hidden");
      });
      $('.top-center-box').on('click', function () {
        $('#overlay').show('slow');
        $('.top-center-box-big').show('slow');
        $('body').css("overflow", "hidden");
      });
      $('.top-right-box').on('click', function () {
        $('#overlay').show('slow');
        $('.top-right-box-big').show('slow');
        $('body').css("overflow", "hidden");
      });
      $('.bottom-left-box').on('click', function () {
        $('#overlay').show('slow');
        $('.bottom-left-box-big').show('slow');
        $('body').css("overflow", "hidden");
      });
      $('.bottom-center-box').on('click', function () {
        $('#overlay').show('slow');
        $('.bottom-center-box-big').show('slow');
        $('body').css("overflow", "hidden");
      });
      $('.bottom-right-box').on('click', function () {
        $('#overlay').show('slow');
        $('.bottom-right-box-big').show('slow');
        $('body').css("overflow", "hidden");
      });
